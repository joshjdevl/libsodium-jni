...
${NDK_ROOT}/build/tools/make-standalone-toolchain.sh --verbose --platform=${NDK_TOOLCHAIN_PLATFORM} --arch=${NDK_TOOLCHAIN_ARCHITECTURE} --install-dir=`pwd`/installs/android-toolchain #--install-dir=${NDK_ROOT}
