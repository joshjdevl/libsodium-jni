...
${NDK_ROOT}/build/tools/make_standalone_toolchain.py --verbose --platform=${NDK_TOOLCHAIN_PLATFORM} --arch=${NDK_TOOLCHAIN_ARCHITECTURE} --install-dir=`pwd`/installs/android-toolchain #--install-dir=${NDK_ROOT}
